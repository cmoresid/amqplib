...
BaseChannel.prototype.registerConsumer = function(tag, callback) {
  console.log({
    msg: 'BaseChannel.prototype.registerConsumer#before',
    data: {
  ...
  console.log({
    msg: 'BaseChannel.prototype.registerConsumer#after',
    data: {
      consumers: this.consumers,
    }
  })
