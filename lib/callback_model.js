...
class Channel extends BaseChannel {
  ...
  consume (queue, callback, options, cb0) {
    console.log({
      msg: 'callback_model.js#Channel.consume',
    })
    ...
    this._rpc(
      ...
      function (err, ok) {
        console.log({
          msg: 'callback_model.js#Channel.consume#rpc',
          data: {
            err,
        ...
        if (err === null) {
          console.log({
            msg: 'callback_model.js#Channel.consume#rpc#err === null',
            data: {
              ok,
            }
          })
          ...
          console.log({
            msg: 'callback_model.js#Channel.consume#rpc#err === null && self.registerConsumer'
          })

          cb(null, ok.fields);

          console.log({
            msg: 'callback_model.js#Channel.consume#rpc#err === null && cb'
          })
        }
        else {
          console.log({
            msg: 'callback_model.js#Channel.consume#rpc#err',
            data: {
              err,
            }
          })
